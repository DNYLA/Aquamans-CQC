class Aqua_Mags
{
	idd = 105; //Should not be 2 as that is a very small number for an IDD number. I Will update this next time i go into the Eden Editor to update the add action.
	movingEnable = true;
	...
	class Controls
	{
		class Mags_762 : Aqua_RscButton
		{
			...
			text = "Add Ammo";
			borderSize = 0;
			action = [] execVM "scripts\Mags\AddMagazines.sqf";
		};
