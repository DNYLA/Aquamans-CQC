...
_TotalMarkers = 7; //-1 total amount of markers since arrays start at 0
_TPFileName = "scripts\TP\ApdTP.sqf"; //File Location of script
_hasSpawned = false;
...
{
    _MarkerNames Set [_i, format["ApdSpawn_%1", _i]]; //Initializing Marker Names
};
