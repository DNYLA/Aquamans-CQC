...
_TotalMarkers = 8; //-1 total amount of markers since arrays start at 0
_TPFileName = "scripts\TP\ChurchTP.sqf"; //File Location of script
_hasSpawned = false;
...
{
    _MarkerNames Set [_i, format["ChurchSpawn_%1", _i]]; //Initializing Marker Names
};
