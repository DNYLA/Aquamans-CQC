...
_TPFileName = "scripts\TP\AirportTP.sqf"; //File Location of script
_hasSpawned = false;
...
{
    _MarkerNames Set [_i, format["AirportSpawn_%1", _i]]; //Initializing Marker Names
};
...
closeDialog 2000; //Closes TP menu if open.
