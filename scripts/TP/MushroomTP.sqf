...
_TotalMarkers = 6; //-1 total amount of markers since arrays start at 0
_TPFileName = "scripts\TP\MushroomTP.sqf"; //File Location of script
_hasSpawned = false;
...
{
    _MarkerNames Set [_i, format["MushroomSpawn_%1", _i]]; //Initializing Marker Names
};
